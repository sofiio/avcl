    ...
    <div className="w-full  mt-16 xl:mt-0">
      ...
      >
        <div className="xl:w-[768px] xl:mt-[112px] mt-[36px] h-[154px] flex items-center text-center">
          <h1 className="text-black md:text-[64px] text-[32px] font-quinapple">
        ...
        <div className="md:w-[700px] lg:w-[768px] flex flex-col items-center md:items-start  w-[343px] space-y-4 xl:space-y-0 h-[465px] mt-[32px] md:mt-[80px]">
          <div>
            <div onClick={toggleDropdown1} className="flex cursor-pointer md:w-[700px] lg:w-[768px] w-[311px] sm:w-[500px] md:h-[72px] h-[41px]  text-black bg-gray-200 items-center sm:justify-between justify-around border-b-2 border-gray-500 sm:px-4 md:px-0">
          ...
          <div>
            <div onClick={toggleDropdown2} className="flex cursor-pointer md:w-[700px] lg:w-[768px] w-[311px] sm:w-[500px] md:h-[72px] h-[41px]  text-black bg-gray-200 items-center sm:justify-between justify-around border-b-2 border-gray-500 sm:px-4 md:px-0">
              <div className="w-[250px] sm:w-auto">
                <h1 className="md:text-[18px] text-[12px] font-bold font-sans">
            ...
            {isDropdownVisible2 && (
              <div className="md:w-[700px] lg:w-[768px] w-[311px] sm:w-[500px] md:h-[450px] h-[420px]  text-black bg-gray-200  flex items-start md:pt-[22px] justify-between sm:px-4 px-2 md:px-0">
                {/* Your dropdown content goes here */}
                <div className="w-[250px] sm:w-auto">
                  <p className="md:text-[18px] text-[12px] md:text-white font-bold font-sans ">
                    <ul className="mt-2">
          ...
          <div>
            <div  onClick={toggleDropdown3} className=" cursor-pointer flex md:w-[700px] lg:w-[768px] w-[311px] sm:w-[500px] md:h-[72px] h-[41px] bg-gray-200 text-black items-center sm:justify-between justify-around border-b-2 border-gray-500 sm:px-4 md:px-0">
              <div className="w-[250px] sm:w-auto">
                <h1 className="md:text-[18px] text-[12px] font-bold font-sans">
          ...
          <div>
            <div  onClick={toggleDropdown4} className=" cursor-pointer flex md:w-[700px] lg:w-[768px] w-[311px] sm:w-[500px] md:h-[72px] h-[41px] bg-gray-200 text-black items-center sm:justify-between justify-around border-b-2 border-gray-500 sm:px-4 md:px-0">
              <div className="w-[250px] sm:w-auto">
                <h1 className="md:text-[18px] text-[12px] font-bold font-sans">
          ...
          <div>
            <div onClick={toggleDropdown5} className=" cursor-pointer flex md:w-[700px] lg:w-[768px] w-[311px] sm:w-[500px] md:h-[72px] h-[41px] bg-gray-200 text-black items-center sm:justify-between justify-around border-b-2 border-gray-500 sm:px-4 md:px-0">
              <div className="w-[250px] sm:w-auto">
                <h1 className="md:text-[18px] text-[12px] font-bold font-sans">
