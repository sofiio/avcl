...
function Footer({
  ...
  return (
    <>
      <div
        className={`w-full xl:h-[542px] h-[650px] mx-auto bg-slate-500 md:bg-white xl:absolute`}
      >
        <div className="2xl:max-w-[1312px] lg:max-w-[1280px] md:max-w-[1024px] max-w-[640px] sm:max-w-[768px] p-4 2xl:p-0 mx-auto">
          <div className="h-[408px] xl:border-b xl:flex xl:flex-row xl:pt-[80px] pt-[20px]">
