  ...
  return (
    <>
      <div className="max-w-[1440px] mx-auto items-center " id="why-choose-us">
        <div className="2xl:ml-[57px] h-[70px] sm:h-[100px] md:h-[150px] xl:h-[160px] 2xl:h-[100px] 2xl:max-w-[1312px] lg:max-w-[1280px] md:max-w-[1024px] max-w-[640px] sm:max-w-[768px] xl:p-4 2xl:p-0  md:mt-[20px] flex text-center justify-center mx-auto 2xl:mx-0">
          <h1 className="xl:text-[25px] p-6 text-[24px] sm:text-[40px] md:text-[64px] font-quinapple text-customDarkBlue">
            ჩვენს შესახებ
          </h1>
        </div>
        <div className="2xl:max-w-[1312px] lg:max-w-[1280px] md:max-w-[1024px] max-w-[640px] sm:max-w-[768px] p-4 2xl:p-0 xl:flex xl:flex-row flex flex-col justify-between lg:mt-[10px] md:mt-[80px] sm:mt-[40px] h-[496px] mx-auto">
          <div className="xl:w-[620px] w-[326px] h-[496px] flex relative mx-auto 2xl:mx-0 mt-8 sm:mt-4 md:mt-0 ">
            <img
          ...
          <div className="md:w-[670px] sm:w-[500px] w-[321px] md:h-[480px] mx-auto md:mx-0 h-[812px] mt-36 md:mt-0 ">
            <h1 className="md:text-[16px] text-[18px] sm:text-[20px]">
